...
namespace Student_Portal.Data.Migrations
{
    ...
    [Migration("20260627084812_AddRegistrationSubmission")]
    partial class AddRegistrationSubmission
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Student_Portal.Models.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Student_Portal.Models.Course", b =>
                {
                    ...
                    b.HasIndex("CourseCode", "Session", "Semester")
                        .IsUnique()
                        .HasFilter("[CourseCode] IS NOT NULL AND [Session] IS NOT NULL");

                    b.ToTable("Courses");
                });

            modelBuilder.Entity("Student_Portal.Models.CourseRegistration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Student_Portal.Models.Document", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Student_Portal.Models.StudentForm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("WAECRegNumber")
                        .HasColumnType("nvarchar(max)");
